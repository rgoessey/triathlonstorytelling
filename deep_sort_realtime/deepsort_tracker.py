...
class DeepSort(object):
    ...
    def update_tracks(self, raw_detections, triatletes,embeds=None, frame=None, today=None, others=None, instance_masks=None):
        ...
        self.tracker.update(detections, triatletes,today=today)
    ...
    def updateFps(self,fps):
        self.tracker.updateFps(fps)

    def geefNumberTracks(self):
        numbers={}
        for t in self.tracker.numberTracks:
            t=self.tracker.numberTracks[t]
            #if self.tracker.numberTracks[t].triatlete.prob > 0.65:
            """if t.is_confirmed():"""
            numbers[t.triatlete.number]=1
        return numbers
    
    """def startNewScene(self):
        self.tracker.startNewScene()"""

    def geefStorytellingScene(self):
        return self.tracker.geefStorytellingScene()
